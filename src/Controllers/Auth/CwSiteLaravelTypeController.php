...
use ConfrariaWeb\CwSiteLaravel\Models\Type;
use ConfrariaWeb\CwSiteLaravel\Models\Option;

class CwSiteLaravelTypeController extends Controller
{
    /**
    ...
    public function index() {
        $data['types'] = Type::all();
        return view('cwsitelaravel::eliteadmin.poststypes.index', $data);
    }
    ...
    public function create() {
        ...
        return view('cwsitelaravel::eliteadmin.poststypes.create', $data);
    }
    ...
    public function show($id) {
        ...
        return view('cwsitelaravel::eliteadmin.poststypes.show', $data);
    }
    ...
    public function edit($id) {
        ...
        return view('cwsitelaravel::eliteadmin.poststypes.edit', $data);
    }
